...
\begin{figure*}
    \centering
    \includegraphics[width=1.6\columnwidth]{figuras/bias_galaxies.pdf}
    \includegraphics[width=1.6\columnwidth]{figuras/ssfr_bias_galaxies.pdf}
    \includegraphics[width=1.6\columnwidth]{figuras/color_bias_galaxies.pdf}
