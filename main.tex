...
The pointss correspond to galaxies (centrals and satellites combined) 
within the same mass bin around $10^{10}$\Msunh. 
These galaxies are split into red and blue $(g-r)$ colours.
Redder (early assembly) galaxies tend to be clustered more tightly
than its bluer (late-assembly) counterparts.
